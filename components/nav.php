...
?>
    <a
      href="parts/_logout.php"
      class="<?php echo (isset($nav_included) && $nav_included) ? 'bg-theme_green text-white' : 'bg-white'; ?> px-4 py-2 rounded-lg"
      >Log out</a
    >
    <?php } else { ?>
    <a
      href="#"
      class="<?php echo (isset($nav_included) && $nav_included) ? 'text-black' : 'text-white'; ?>"
      >Log in</a
    >
    <a
      href="signup.php"
